...
void Id0x1818d0f3::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_fbatvolt(fbatvolt(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_fbatcur(fbatcur(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_fbatsoc(fbatsoc(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatcellvolthigh(bybatcellvolthigh(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatcellvoltlow(bybatcellvoltlow(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatsochigh(bybatsochigh(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatsoclow(bybatsoclow(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatinnercommerr(bybatinnercommerr(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatvoltlow(bybatvoltlow(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatvolthigh(bybatvolthigh(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatimbalance(bybatimbalance(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatheatuprateerr(bybatheatuprateerr(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatsmokeerr(bybatsmokeerr(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatinsrerr(bybatinsrerr(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatdsgcurhigh(bybatdsgcurhigh(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatchrgcurhigh(bybatchrgcurhigh(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybattemphigh(bybattemphigh(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybattempdiffhigh(bybattempdiffhigh(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatcoolrun(bybatcoolrun(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatnegrlysts(bybatnegrlysts(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_byhaslargerescell(byhaslargerescell(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_byhassmallcapcell(byhassmallcapcell(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_byhasbatchargercomm(byhasbatchargercomm(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatchrgcc(bybatchrgcc(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatinchrg(bybatinchrg(bytes, length));
  chassis->mutable_diamond()->mutable_id_0x1818d0f3()->set_bybatfusests(bybatfusests(bytes, length));
}
...
bool Id0x1818d0f3::bybatcellvolthigh(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Id0x1818d0f3::bybatcellvoltlow(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Id0x1818d0f3::bybatsochigh(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Id0x1818d0f3::bybatsoclow(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Id0x1818d0f3::bybatinnercommerr(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Id0x1818d0f3::bybatvoltlow(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Id0x1818d0f3::bybatvolthigh(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Id0x1818d0f3::bybatimbalance(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Id0x1818d0f3::bybatheatuprateerr(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(0, 1);
...
bool Id0x1818d0f3::bybatsmokeerr(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(1, 1);
...
bool Id0x1818d0f3::bybatinsrerr(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(2, 1);
...
bool Id0x1818d0f3::bybatdsgcurhigh(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(3, 1);
...
bool Id0x1818d0f3::bybatchrgcurhigh(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(4, 1);
...
bool Id0x1818d0f3::bybattemphigh(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(5, 1);
...
bool Id0x1818d0f3::bybattempdiffhigh(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(7, 1);
...
bool Id0x1818d0f3::bybatcoolrun(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
  int32_t x = t0.get_byte(0, 1);
...
bool Id0x1818d0f3::bybatnegrlysts(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
  int32_t x = t0.get_byte(1, 1);
...
bool Id0x1818d0f3::byhaslargerescell(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
  int32_t x = t0.get_byte(2, 1);
...
bool Id0x1818d0f3::byhassmallcapcell(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
  int32_t x = t0.get_byte(3, 1);
...
bool Id0x1818d0f3::byhasbatchargercomm(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
  int32_t x = t0.get_byte(4, 1);
...
bool Id0x1818d0f3::bybatchrgcc(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
  int32_t x = t0.get_byte(5, 1);
...
bool Id0x1818d0f3::bybatinchrg(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
  int32_t x = t0.get_byte(6, 1);
...
bool Id0x1818d0f3::bybatfusests(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
  int32_t x = t0.get_byte(7, 1);
