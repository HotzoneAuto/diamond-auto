...
class Id0x181ed0f3 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  bool bybatheatcircuiterr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bybatselfprotecterr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bybatbranchbreakerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bytmsrlynotcloseerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bytmsrlynotopenerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bybatnegrlynotcloseerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bychrgaposrlynotopenerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bychrgaposrlynotcloseerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bychrganegrlynotcloseerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bychrganegrlynotopenerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bychrgbposrlynotcloseerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bychrgbposrlynotopenerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bychrgbnegrlynotcloseerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bychrgbnegrlynotopenerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bydsgcurhghwhenchrg(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bybatchrgsignalerr(const std::uint8_t* bytes, const int32_t length) const;
