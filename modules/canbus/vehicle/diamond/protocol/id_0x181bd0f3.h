...
class Id0x181bd0f3 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  bool bychrgseattemphigh(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool bymainrlynotopenerr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  bool byremainrlynotopenerr(const std::uint8_t* bytes, const int32_t length) const;
