...
class Id0x1818d0f3 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  // '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'bool'}
  bool bybatheatuprateerr(const std::uint8_t* bytes,
                          const int32_t length) const;

  // config detail: {'bit': 49, 'is_signed_var': False, 'len': 1, 'name':
  // 'byBatSmokeErr', 'offset': 0.0, 'order': 'intel', 'physical_range':
  // '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'bool'}
  ...
  // 'byBatTempHigh', 'offset': 0.0, 'order': 'intel', 'physical_range':
  // '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'bool'}
  ...
  // 'byBatNegRlySts', 'offset': 0.0, 'order': 'intel', 'physical_range':
  // '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'bool'}
  ...
  // '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'bool'}
  bool byhasbatchargercomm(const std::uint8_t* bytes,
                           const int32_t length) const;
